...
const Database = {
  ...
  getAll: () => {
    return Array.from(courses.entries()).map(([id, course]) => ({ // TODO: mostrar en orden cronológico inverso
        id,
        title: course.title,
    ...
    // If the course doesn't exist, it returns undefined (.get implements this behavior)
  getById: (id) => {
